...
function statRoll() {
     ...
     if (statSum <= 72) {document.getElementById("rngQuote").value="Maybe you should just be a farmer...";}
     if (statSum >= 80) {document.getElementById("rngQuote").value="With great power comes great responsibility.";}
     if (statSum > 72 && statSum < 80) {document.getElementById("rngQuote").value="It's a dangerous business, going out your door. If you don't keep your feet, there's no telling where you might be swept off to.";}
}
