<html>
     ...
     <body  onload="initQuote()">
          <form  name="input" id="input" action="">
               ...
               <input type="number" name="numberDice" id="numberDice" value="6" max="999" min="1" size="4">
               <br>
               <label for="sides">Number of sides:</label>
               <input type="number" name="sides" id="sides" value="8" max="999" min="1" size="4">
               <br>
               ...
               <input type="number" name="mods" id="mods" value="0" max="999" min="-999" size="4"> )
               <br>
